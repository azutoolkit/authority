  ...
  def change(direction)
    direction.up do
      create_table :authorization_codes do |t|
        t.column :authorization_code, "varchar(128)", null: false, index: true, unique: true
        ...
        t.column :code_challenge, "varchar(128)", null: true
        t.column :code_challenge_method, "varchar(10)", null: true
